...
function Reactions({
  ...
  // const slug = pathname === '/' ? 'home' : pathname.split('/').reverse()[0];
  const slug = 'home';
      ...
      <div className={clsx('flex items-center gap-4')}>
        <div className={clsx('flex flex-col items-center gap-2')}>
          <EmojiReaction
            ...
            defaultImage={
              CLAPPING_QUOTA <= 0
                ? '/assets/emojis/love-you-gesture.png'
                : '/assets/emojis/clapping-hands.png'
            }
            animatedImage={
              CLAPPING_QUOTA <= 0
                ? '/assets/emojis/love-you-gesture.png'
                : '/assets/emojis/clapping-hands-animated.png'
            }
        ...
        <div className={clsx('flex flex-col items-center gap-2')}>
          <EmojiReaction
            ...
            defaultImage={
              AMAZED_QUOTA <= 0
                ? '/assets/emojis/star-struck.png'
                : '/assets/emojis/astonished-face.png'
            }
            animatedImage={
              AMAZED_QUOTA <= 0
                ? '/assets/emojis/star-struck.png'
                : '/assets/emojis/astonished-face-animated.png'
            }
        ...
        <div className={clsx('flex flex-col items-center gap-2')}>
          <EmojiReaction
            ...
            defaultImage={
              THINKING_QUOTA <= 0
                ? '/assets/emojis/nerd-face.png'
                : '/assets/emojis/face-with-monocle.png'
            }
            animatedImage={
              THINKING_QUOTA <= 0
                ? '/assets/emojis/nerd-face.png'
                : '/assets/emojis/face-with-monocle-animated.png'
            }
