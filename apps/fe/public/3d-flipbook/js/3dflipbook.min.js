!(function (modules) {
      ...
      MathUtils = (function (_BaseMathUtils) {
        ...
        return (
          ...
          (MathUtils.getLinearIndeces = function (spline, n) {
            for (
              var del = 5e3, dDel = 1 / del, ls = [0], l = 0, i = 0;
              i <= del;
              ++i
            ) {
      ...
      ImageBase = (function () {
        ...
        return (
          ...
          (ImageBase.prototype.pushCtx = function () {
            return (
              this.resW != this.c.width && (this.c.width = this.resW),
      ...
      SheetBlock = (function () {
        function SheetBlock(visual, p, first, last) {
          ...
          if (
            ...
            (this.mesh = new _libs.THREE.Mesh(
              this.geometry,
              new _libs.THREE.MeshFaceMaterial(this.materials)
            )),
        ...
        return (
          ...
          (SheetBlock.prototype.getTopCerners = function () {
            var off =
              this.angle > Math.PI / 2 ? this.geometry.vertices.length / 2 : 0;
            return [
          ...
          (SheetBlock.prototype.getTopWorldPosition = function (v) {
            var l = this.geometry.vertices.length,
              ...
              vs = [
                ...
                this.geometry.vertices[
                  _sheetBlock2.default.resZ * _sheetBlock2.default.resX -
                    1 +
                    off
                ],
              ];
          ...
          (SheetBlock.prototype.set = function (angle) {
            ...
            var closedAngle = void 0,
              binderTurn = void 0;
            ('object' ===
            ('undefined' == typeof angle ? 'undefined' : _typeof(angle))
              ...
              interpolationPoints = [
                ...
                },
                {
                  x: [
                    ...
                    [0, 0.286, 0.632, 0.815, 0.997],
                    [0, 0.279, 0.623, 0.806, 0.988],
                    [0, 0.233, 0.563, 0.746, 0.927],
                    [0, 0.144, 0.433, 0.613, 0.796],
                    [0, 0.07, 0.288, 0.455, 0.626],
                    [0, 0, 0, 0, 0],
                    x,
                  ],
                  y: [
                    ...
                    [0, 0.03, 0.01, 0.002, 0],
                    [0, 0.06, 0.017, 0.004, 0],
                    [0, 0.168, 0.269, 0.27, 0.255],
                    [0, 0.245, 0.435, 0.458, 0.46],
                    [0, 0.278, 0.544, 0.614, 0.673],
                    [0, 0.2877, 0.6347, 0.8174, 1],
                    y,
                  ],
                },
  ...
  function (module, exports) {
    ...
    function props() {
      return {
        ...
        cover: { binderTexture: '', depth: 3e-4, padding: 0, mass: 0.003 },
  ...
  function (module, exports, __webpack_require__) {
    ...
    var _libs = __webpack_require__(0),
      _Utils = __webpack_require__(4),
      _Utils2 = _interopRequireDefault(_Utils);
    ((_libs.PDFJS.workerSrc = (
      window.PDFJS_LOCALE
        ? PDFJS_LOCALE
        : {
            pdfJsWorker: '/3d-flipbook/js/pdf.worker.js',
            pdfJsCMapUrl: 'cmaps/',
          }
    ).pdfJsWorker),
      (_libs.PDFJS.cMapUrl = (
      ...
      function Pdf(src, loadingProgress) {
        ...
        (_classCallCheck(this, Pdf),
          ...
          _libs.PDFJS.getDocument(
            { url: this.src, rangeChunkSize: 524288 },
            null,
            null,
            function (data) {
        ...
        (Pdf.prototype.init = function (handler, pages) {
          ((this.handler = handler),
            (this.doubledPages =
              !!pages &&
              Math.abs(
                2 * Pdf.getPageSize(pages[0]).width -
                  Pdf.getPageSize(pages[1]).width
              ) /
                Pdf.getPageSize(pages[0]).width <
                1e-4));
          for (
    ...
    ((_libs.$.fn.FlipBook = function (options) {
      ...
      return (
        ...
        (scene.view = new _BookView2.default(
          this.length ? this[0] : (0, _libs.$)('<div>').appendTo('body'),
          function () {
            _Detector2.default.webgl
              ? ((scene.loadingCtrl = new _LoadingController2.default(
                  scene.view,
                  !0,
                  function (progress) {
                    return 0 === progress
                      ? (0, _libs.tr)('Vui lòng chờ...')
      ...
      Binder = (function () {
        function Binder(visual, p) {
          ...
          (_classCallCheck(this, Binder),
            ...
            (this.materials = [
              new _libs.THREE.MeshPhongMaterial({ color: p.cover.color }),
              new _libs.THREE.MeshPhongMaterial({ color: p.cover.color }),
              new _libs.THREE.MeshPhongMaterial({ color: p.cover.color }),
              new _libs.THREE.MeshPhongMaterial({ color: p.cover.color }),
              new _libs.THREE.MeshPhongMaterial({ color: p.cover.color }),
        ...
        return (
          ...
          (Book.prototype.isActivePage = function (n) {
            ...
            if (n > 1 && n < this.getPages() - 2)
              for (
                var _iterator = this.sheetBlocks,
                  _isArray = Array.isArray(_iterator),
                  _i = 0,
                  _iterator = _isArray
                    ? _iterator
            ...
            if (this.angle === PI / 2 || this.angle === (3 * PI) / 2) {
              ...
              this.angle < PI / 2
                ...
                : this.angle > (3 * PI) / 2
                  ...
                  : this.angle < PI
                    ? (p = this.getPages() - 3)
                    : this.angle >= PI && (p = this.getPages() - 1);
            return p;
          }),
          ...
          (Book.prototype.flipLeft = function () {
            var _this2 = this,
              ...
              res = void 0;
            return (
              this.sheetPhysics.getSize() < 25 &&
                !(function () {
                  var left = _this2.sheetBlocks[0],
                    PI = Math.PI;
                  _this2.angle === PI
                    ? (res = _this2.connectPhysics(
                        (block = _this2.rightCover),
                        _this2.p.cover.mass,
                        PI,
                        -_this2.p.cover.startVelocity,
                        _this2.p.cover.flexibility,
                        0,
                    ...
                    : left && 'closed' === left.state && left.angle > PI / 2
                      ? ((block =
                        ...
                        (res = _this2.connectPhysics(
                          block,
                          _this2.p.page.mass * block.getSize(),
                          PI,
                          -_this2.p.page.startVelocity,
                          _this2.p.page.flexibility,
                          0,
                          function (angle, height) {
                            return block.set(
              ...
              this.sheetPhysics.getSize() < 25 &&
                !(function () {
                  var right = _this3.sheetBlocks[_this3.sheetBlocks.length - 1],
                    PI = Math.PI;
                  0 === _this3.angle
                    ? (res = _this3.connectPhysics(
                        (block = _this3.leftCover),
                        _this3.p.cover.mass,
                        0,
                        _this3.p.cover.startVelocity,
                        _this3.p.cover.flexibility,
                        0,
                        function (angle, height) {
                    ...
                    : right && 'closed' === right.state && right.angle <= PI / 2
                      ? ((block =
                          size < right.getSize()
                            ? _this3.splitSheetBlock(
                                _this3.sheetBlocks.length - 1,
                                size
                              )[0]
                            : right),
                        (res = _this3.connectPhysics(
                          block,
                          _this3.p.page.mass * block.getSize(),
                          0,
                          _this3.p.page.startVelocity,
                          _this3.p.page.flexibility,
                          0,
                          function (angle, height) {
                            return block.set(
            ...
            this.mouseController &&
              !(function () {
                var _data$data = data.data,
                  ...
                  n = _data$data.n;
                if ('mouseover' === e.type)
                  _this4.hoverInfo && void 0 !== _this4.hoverInfo.pendings
                    ? ++_this4.hoverInfo.pendings
                    : (_this4.hoverInfo &&
                        (console.warn('Wrong state: element is already hover'),
                        _this4.hoverInfo.n !== n && _this4.clearHoverInfo()),
                      _this4.hoverInfo ||
                        _this4.dragInfo ||
                        !(function () {
                          ...
                          if (
                            ...
                            var sheetBlocks = [_this4.leftCover].concat(
                                _this4.sheetBlocks,
                                [_this4.rightCover]
                              ),
                            ...
                            (!nextBlock ||
                              ...
                              (nextBlock.angle > hoverAngle &&
                                nextBlock.angle < Math.PI - hoverAngle)) &&
                ...
                else if (_this4.hoverInfo && 'mouseout' === e.type)
                  void 0 !== _this4.hoverInfo.pendings
                    ? --_this4.hoverInfo.pendings
                    : n === _this4.hoverInfo.n && _this4.clearHoverInfo();
                else if ('mousedown' === e.type)
                  _this4.cornerClickData = { x: e.pageX, y: e.pageY };
                else if ('click' === e.type) {
                  if (
                    Math.sqrt(
                      Math.pow(_this4.cornerClickData.x - e.pageX, 2) +
                        Math.pow(_this4.cornerClickData.y - e.pageY, 2)
                    ) < 5
                  ) {
          ...
          (Book.calcProps = function (props) {
            var p = _extends({}, props, {
              ...
              sheet = {
                sideTexture:
                  p.sheet.sideTexture || Book.createSideTexture(p.sheet.color),
              },
              ...
              marker = { use: !1, color: 16711680, size: 0.001 * scale };
            return (
      ...
      BookController = (function (_Controller) {
        function BookController(book, view, props) {
          ...
          return (
            ...
            _this.book.setAutoResolution(
              _this.p.autoResolution.enabled,
              _this.p.autoResolution.coefficient
            ),
            _this
          );
        }
        return (
          ...
          (BookController.prototype.dispose = function () {
            (_FullScreen2.default.removeEventListener(
            ...
            var _this2 = this,
              handler = function () {
                for (
                  ...
                  if ((visible = void 0 === state || 'loading' === state))
                    break;
                }
          ...
          (BookController.prototype.setBookZoom = function (scale) {
            var _this3 = this;
            setTimeout(function () {
              _this3.bookWatcher.scale === scale &&
          ...
          (BookController.prototype.cmdFullScreen = function () {
            _FullScreen2.default.activated()
          ...
          (BookController.prototype.goToPage = function (page) {
            ...
            var target = Math.max(
                Math.min(page - 1 + (page % 2), this.book.getPages() - 1),
                0
              ),
            ...
            if (target != current) {
              0 === current
                ...
                : current === this.book.getPages() - 1 &&
                  (flips.push(-1), (current -= 2), ++covs);
              var cv = 0;
              (0 === target
                ? ((cv = -1), (target += 1), ++covs)
                : target === this.book.getPages() - 1 &&
                  ((cv = 1), (target -= 2), ++covs),
                target - current &&
          ...
          (BookController.prototype.startFlip = function (flipRes) {
            ...
            return flipRes
              ? flipRes.then(function (block) {
                  return (
                    block && _this7.dispatchAsync({ type: 'startFlip' }),
                    block
                  );
                })
          ...
          (BookController.prototype.updateViewState = function () {
            this.viewState = {
              ...
              cmdFullScreen: {
                ...
                active:
                  _FullScreen2.default.available() &&
                  _FullScreen2.default.activated(),
              },
              widSettings: {
                enable: !0,
              ...
              cmdLightingUp: {
                enable:
                  Math.abs(this.state.lighting - this.p.lighting.max) >
                  this.p.eps,
              ...
              cmdLightingDown: {
                enable:
                  Math.abs(this.state.lighting - this.p.lighting.min) >
                  this.p.eps,
              ...
              mouseCmdWheelZoom: {
                activate: function (e) {
                  (e.preventDefault(),
                    e.deltaY < 0
                      ? _this8.cmdZoomOut()
                      : e.deltaY > 0 && _this8.cmdZoomIn());
                },
              },
              touchCmdRotate: {
                activate: function (e, data) {
                  isSwipping('touchCmdRotate') ||
                    (e.preventDefault(), _this8.orbit.actions.rotate(e, data));
                },
              },
              touchCmdZoom: {
                activate: function (e, data) {
                  isSwipping('touchCmdZoom') ||
                    (e.preventDefault(),
                    data.dy > 0
                      ? _this8.cmdZoomOut()
                      : data.dy < 0 && _this8.cmdZoomIn());
              ...
              touchCmdPan: {
                activate: function (e, data) {
                  isSwipping('touchCmdPan') ||
                    (e.preventDefault(), _this8.orbit.actions.pan(e, data));
                },
              },
              touchCmdSwipe: {
                activate: function (e, data) {
                  if (isSwipping('touchCmdSwipe'))
                    if ((e.preventDefault(), 'start' === data.state)) {
                      var touch = (e.touches || e.originalEvent.touches)[
                        _this8.actions.touchCmdSwipe.code - 1
                      ];
                      _this8.swipeData = {
                        handled: !1,
                        x0: touch.pageX,
                      ...
                      'move' === data.state
                        ? _this8.swipeData.handled ||
                          ((_this8.swipeData = _extends({}, _this8.swipeData, {
                            x: _this8.swipeData.x + data.dx,
                            y: _this8.swipeData.y + data.dy,
                          })),
                          Math.abs(_this8.swipeData.x0 - _this8.swipeData.x) >
                            100 &&
                            (_this8.swipeData.x0 > _this8.swipeData.x
                              ? _this8.cmdForward()
                              : _this8.cmdBackward(),
                            (_this8.swipeData.handled = !0)))
    ...
    var _BookPropsBuilder2 = __webpack_require__(9),
      ...
      ClbBookPropsBuilder = (function (_BookPropsBuilder) {
        function ClbBookPropsBuilder(context, pageCallback, pages, onReady) {
          ...
          var _this = _possibleConstructorReturn(
            this,
            _BookPropsBuilder.call(this, onReady)
          );
          return (
      ...
      CssLayersManager = (function () {
        ...
        return (
          ...
          (CssLayersManager.prototype.hide = function () {
            ...
            for (
              var wait = [],
                _iterator4 = Object.values(this.wrappers),
                _isArray4 = Array.isArray(_iterator4),
                _i4 = 0,
                _iterator4 = _isArray4
                  ? _iterator4
          ...
          (_classCallCheck(this, PageManager),
            ...
            visual.addObject(
              new _libs.THREE.Mesh(
                new _libs.THREE.PlaneGeometry(0, 0),
                this.tmpMaterial
              )
            ),
            ...
            setTimeout(this.updateRenderQueue.bind(this), 0));
        }
        return (
          ...
          (PageManager.prototype.isMobile = function () {
            var userAgent =
              this.visual.wnd.navigator.userAgent ||
              this.visual.wnd.navigator.vendor ||
              this.visual.wnd.opera;
            return (
          ...
          (PageManager.prototype.update = function (dt) {
            if (this.loadingAnimation) {
              ...
              for (
                var _iterator4 = Object.keys(loading),
                  _isArray4 = Array.isArray(_iterator4),
                  _i4 = 0,
                  _iterator4 = _isArray4
                    ? _iterator4
          ...
          (PageManager.prototype.load = function (material, n) {
            ...
            return (
                    ...
                    (o.wrapper.onChange = function (image) {
                      o.texture &&
                        ...
                        o.material &&
                          ...
                          (o.material.color = new _libs.THREE.Color(16777215)),
              ...
              this.book.dispatchEvent({ type: 'loadPage', page: n }),
              this.pageCache.put(n, o)
            );
          }),
          (PageManager.prototype.isSinglePage = function (o) {
            return (
              this.p.singlePage || !o.n || o.n === this.book.getPages() - 1
            );
          }),
          (PageManager.prototype.calcResolution = function (o) {
            ...
            if (this.p.autoResolution.enable) {
              ...
              res = {
                width:
                  this.p.autoResolution.k * this.p.zoom * k * o.widthTexels,
                height:
                  this.p.autoResolution.k * this.p.zoom * k * o.heightTexels,
              };
          ...
          (PageManager.prototype.updateRenderQueue = function () {
            if (this.canvas) {
              ...
              if (
                !this.rendering &&
                (p.renderWhileFlipping || !this.book.isProcessing())
              ) {
                for (
                  var active = void 0,
                    top = void 0,
                    _iterator6 = this.renderQueue,
                    _isArray6 = Array.isArray(_iterator6),
                    _i6 = 0,
                    _iterator6 = _isArray6
                      ? _iterator6
          ...
          (PageManager.prototype.loadPredictedPages = function () {
            this.predictedRequests = _BaseMathUtils2.default.predict(
              this.pageRequests,
              this.p.preloadPages
            );
            for (
              var _iterator7 = this.predictedRequests,
                _isArray7 = Array.isArray(_iterator7),
                _i7 = 0,
                _iterator7 = _isArray7
                  ? _iterator7
              ...
              var p = _ref7;
              p < this.book.getPages() &&
                !this.pageCache.get(p) &&
                this.load(void 0, p);
            }
          }),
          (PageManager.prototype.addPageRequest = function (n) {
            (this.pageRequests.push(n),
              this.pageRequests.length > this.p.pagesForPredicting &&
          ...
          (PageManager.prototype.getOrLoadTextureObject = function (
            ...
            return (
              object
                ...
                : ((object = this.load(material, n)), this.addPageRequest(n)),
              object
            );
          }),
          (PageManager.prototype.setTexture = function (material, n) {
            (~this.predictedRequests.indexOf(n) && this.addPageRequest(n),
            ...
            switch (e.type) {
              ...
              case 'click':
                if (anno.url) this.callHandlers('external', anno.url);
                  ...
                  ((destPromise =
                    'string' == typeof anno.dest
                      ? this.pdf.handler.getDestination(anno.dest)
                      : Promise.resolve(anno.dest)),
                    destPromise
                      .then(function (dest) {
                        return 'number' == typeof dest[0]
                          ? dest[0]
                          : _this.pdf.handler.getPageIndex(dest[0]);
                      })
            ...
            if (this.update) {
              ...
              this.page < this.pages &&
                !(function () {
                  ...
                  _this
                    .find(_this.pageCallback(_this.page))
        ...
        return (
          ...
          (SheetPhysics.prototype.getParametr = function (id, name) {
            var o = this.os.find(function (o) {
              ...
              value = void 0;
            return (value =
              'angle' === name ? o.l / this.p.r : o[this.getParametrMap(name)]);
          }),
          ...
          (SheetPhysics.prototype.findCollisions = function (os) {
            for (
              ...
              (os[i - 1].l > os[i].l || this.isCollision(os[i - 1], os[i])) &&
                ...
                ++ci.num,
                (ci.last = i),
                ci.all.indexOf(i - 1) === -1 && ci.all.push(i - 1),
                ci.all.indexOf(i) === -1 && ci.all.push(i));
            return ci;
          }),
    ...
    var _WidgetController2 = __webpack_require__(67),
      ...
      TocController = (function (_WidgetController) {
        function TocController(view, bookCtrl) {
          ...
          var _this = _possibleConstructorReturn(
            this,
            _WidgetController.call(this, view)
          );
        ...
        return (
          ...
          (TocController.prototype.setBookmarks = function (bookmarks, pdf) {
            ((this.bookmarks = bookmarks),
              ...
              bookmarks.getSize() &&
                ((this.tab = 'bookmarks'), (this.isBookmarks = !0)),
              this.fireChange());
          }),
          ...
          (TocController.prototype.navigateBookmarks = function (item) {
            ...
            if (item.url) window.open(item.url, '_blank');
              ...
              var destPromise = void 0;
              ((destPromise =
                'string' == typeof item.dest
                  ? this.pdf.handler.getDestination(item.dest)
  ...
  function (module, exports, __webpack_require__) {
    ...
    var _libs = __webpack_require__(1),
      ...
      scale = 1,
      faces = [],
      frontGeometry = new _libs.THREE.PlaneGeometry(
        scale,
        scale,
        resX - 1,
        resY - 1
  ...
  function (module, exports) {
    ...
    function props() {
      return {
        ...
        scale: { default: 0.8, min: 0.8, max: 2.5, levels: 7 },
        lighting: { default: 1, min: 0.5, max: 1, levels: 7 },
        pan: { speed: 50 },
        ...
        actions: {
          ...
          touchCmdPan: { enabled: !1, type: 'touchdrag', code: 1 },
                      ...
                      ? ((node.minimized = !node.minimized),
                        node.minimized
                          ...
                          : (li.find('.togle').removeClass('minimized'),
                            li.append(
                              (_this.renderNode(node).match(/<ul.*<\/ul>/) || [
                                '',
                              ])[0]
                            )))
      ...
      function cloneNode(node, filter, root) {
        ...
        function cloneChildren(original, clone, filter) {
          ...
          return 0 === children.length
            ...
            : cloneChildrenInOrder(clone, util.asArray(children), filter).then(
                function () {
                  return clone;
                }
              );
            ...
            function clonePseudoElement(element) {
              function formatPseudoElementStyle(className, element, style) {
                ...
                function formatCssProperties(style) {
                  ...
                  return (
                    util.asArray(style).map(formatProperty).join('; ') + ';'
                  );
                }
          ...
          return function () {
            function fourRandomChars() {
              return (
                '0000' +
                (
                  (self.window.Math.random() * self.window.Math.pow(36, 4)) <<
                  0
                ).toString(36)
              ).slice(-4);
            }
      ...
      function newImages() {
        ...
        function inlineAll(node) {
          ...
          return util.isElement(node)
            ? inlineBackground(node).then(function () {
        ...
        return (
          ...
          (Drag.prototype.setCoordsFromEvent = function (e) {
            ...
            return (
              ...
              (this.coords.y =
                2 * -((e.pageY - offset.top) / jElement.height()) + 1),
              this.coords
            );
          }),
        ...
        return (
          ...
          (LoadingAnimation.prototype.update = function (T) {
            if (
              ...
              this.t = 0;
              var r = 0.15 * Math.min(this.c.width, this.c.height),
                a = this.os[1],
                x0 = 0.5 * this.c.width,
              ...
              var ps = 10,
                da = (2 * Math.PI) / ps;
              ctx.shadowColor = _GraphUtils2.default.color2Rgba(
                _GraphUtils2.default.inverseColor(this.p.color, 0.2),
                1
              );
              for (
                var i = 0, _a = a, _r = 0.5 * r;
                i < ps;
                ++i, _r *= 0.8, _a += da
              ) {
                (ctx.beginPath(),
        ...
        function Orbit(object, domElement) {
          ...
          function rotate(event, data) {
            if (scope.enabled && scope.enableRotate && 'move' === data.state) {
              ...
              (rotateLeft(
                ((2 * Math.PI * data.dx) / element.clientWidth) *
                  scope.rotateSpeed
              ),
                rotateUp(
                  ((2 * Math.PI * data.dy) / element.clientHeight) *
                    scope.rotateSpeed
                ),
                scope.update());
            }
            ...
            if (this.finder) {
              for (
                var testSz =
                  ...
                  _iterator3 = this.finder.getHits(),
                  _isArray3 = Array.isArray(_iterator3),
                  _i3 = 0,
                  _iterator3 = _isArray3
                    ? _iterator3
              ...
              this.pdf
                ...
                .then(function (page) {
                  ((_this4.page = page),
                    ...
                    page
                      .getAnnotations()
                      .then(_this4.setAnnotations.bind(_this4)),
        ...
        return (
          ...
          (ThreeTouchEventConverter.prototype.setCoordsFromEvent = function (
            ...
            return (
              ...
              (this.coords.y =
                2 * -((pageY - offset.top) / jElement.height()) + 1),
              this.coords
            );
          }),
        ...
        return (
          ...
          (Thumbnails.prototype.render = function () {
            for (
              ...
              elements.push(
                [
                  '<div class="item"><a href="#"><div class="thumbnail loading"></div></a><div class="heading"><a href="#" title="',
                  i + 1,
                  '">',
                  i + 1,
                  '</a></div></div>',
        ...
        function View(parentContainer, onLoad) {
          ...
          (_classCallCheck(this, View),
            ...
            this.isIOS &&
              ...
              ).on('resize', this.binds.onResize),
              this.onResize(),
              setTimeout(this.checkIframeSize.bind(this), 0)),
          ...
          this.loadFiles(urls, files)
            .then(function () {
              ...
              for (
                ...
                _this3.jLinks.push(
                  (0, _libs.$)(
                    ['<link ', _this3.objToAttrsStr(_link), '>'].join('')
                  ).appendTo(_this3.head)
                );
              }
              if (files.script[0]) {
      ...
      VisualWorld = (function (_THREE$EventDispatche) {
        function VisualWorld(wnd, doc, container) {
          ...
          ((_this.camera.position.x = 0),
            ...
            _this.renderer.setClearColor(0x1a1a1a, 0.8),
          ...
          (_this.controls.addEventListener('change', function () {
            ...
            _this.scene.add(new _libs.THREE.AmbientLight(13684944, 0.8)),
            (_this.light = new _libs.THREE.DirectionalLight(4210752, 1.5)),
        ...
        return (
          ...
          (VisualWorld.prototype.processGeometry = function (
            bufGeometry,
            mesh
          ) {
            mesh.geometry = bufGeometry;
            var geometry = new _libs.THREE.Geometry().fromBufferGeometry(
              bufGeometry
            );
            geometry.mergeVertices();
            var indexedBufferGeom =
              this.createIndexedBufferGeometryFromGeometry(geometry);
            return this.mapIndices(bufGeometry, indexedBufferGeom);
          }),
          (VisualWorld.prototype.createIndexedBufferGeometryFromGeometry =
            function (geometry) {
              for (
                var numVertices = geometry.vertices.length,
                  numFaces = geometry.faces.length,
                  bufferGeom = new _libs.THREE.BufferGeometry(),
                  vertices = new Float32Array(3 * numVertices),
                  indices = new (
                    3 * numFaces > 65535 ? Uint32Array : Uint16Array
                  )(3 * numFaces),
                  i = 0;
                i < numVertices;
                i++
              ...
              return (
                bufferGeom.setIndex(
                  new _libs.THREE.BufferAttribute(indices, 1)
                ),
                bufferGeom.addAttribute(
                  'position',
                  new _libs.THREE.BufferAttribute(vertices, 3)
                ),
                bufferGeom
              );
            }),
          ...
          (VisualWorld.prototype.mapIndices = function (
            bufGeometry,
            indexedBufferGeom
          ) {
          ...
          (VisualWorld.prototype.multyNodePositionCallback = function (
            node,
            p,
            n
          ) {
            for (
              var geometry = this.geometry,
                volumePositions = geometry.attributes.position.array,
                volumeNormals = geometry.attributes.normal.array,
                assocVertex = geometry.mappedAssociation[node],
                k = 0;
              k < assocVertex.length;
              k++
            ) {
